const SkeletonHeader = () => {
  return (
    <>
      <div className="w-full h-detailCardContentMobile md:h-detailCardContentDekstop bg-white border-primary border rounded-10 p-4 flex flex-col gap-2 justify-center">
      ...
      <div className="w-full h-detailCardContentMobile md:h-detailCardContentDekstop rounded-10 border border-primary md:col-span-3 flex items-center justify-center flex-col gap-2 bg-white">
